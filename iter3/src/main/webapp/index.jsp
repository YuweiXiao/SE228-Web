	...
	<div id="carousel-index-generic" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="<%= path %>/static/image/1.jpg" alt="...">
				<div class="carousel-caption">
					...
				</div>
			</div>
			<div class="item">
				<img src="<%= path %>/static/image/2.jpg" alt="...">
				<div class="carousel-caption">
				...
				</div>
			</div>
			<div class="item">
				<img src="<%= path %>/static/image/3.jpg" alt="...">
				<div class="carousel-caption">
				...
				</div>
			</div>
			...
			<table class="table table-striped">
		        ...
		        <s:iterator value="#books">
		            <tr>
		               ...
		               <!--  <td><button class="btn btn-default btn-detail" onclick="showDetail(<s:property value='bookID'/>)">
		            	    	Detail
		                </button></td> -->
		                 <td><button class="btn btn-default btn-detail" ng-click="getDetail(<s:property value='bookID'/>)">
		            	    	Detail
		                </button></td>
		            </tr>
				</s:iterator>
