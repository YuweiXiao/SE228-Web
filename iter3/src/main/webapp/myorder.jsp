...
<div class="container index-content">
	...
	<ul class="pagination">
        <li>
            <a href="<%=path%>/order/action_listUserOrder?page=1">First</a>
        </li>
        <s:if test="#page.hasPreviousPage">
	        <li>
	            <a href="<%=path%>/order/action_listUserOrder?page=<s:property value='#page.prepage'/>">
	            Previous
	            </a>
	        </li>
        </s:if>
        <s:iterator value="#page.list" id = "pageno">
        	<s:if test="#pageno == #page.currentPage">
        		<li class="active">
        			<a "#"><s:property value="pageno"/></a>
        		</li>  
        	</s:if> <s:else>
        		<li>
        			<a href="<%=path%>/order/action_listUserOrder?page=<s:property value='pageno'/>"><s:property value="pageno"/></a>
        		</li>
        	</s:else>
        ...
        <s:if test="#page.hasNextPage">
	        <li>
	            <a href="<%=path%>/order/action_listUserOrder?page=<s:property value='#page.nextPage'/>">
	            Next
	            </a>
	        </li>
        </s:if>
        <li>
            <a href="<%=path%>/order/action_listUserOrder?page=<s:property value='#page.totalPage'/>">Last</a>
        </li>
    </ul>
