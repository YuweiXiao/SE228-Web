...
<body>
    <div style="width:96%; margin-left:auto;margin-right:auto;">
    	...
    	<div style="float:left;width:12%">
    		<ul class="nav">
	            ...
	            <li><a href="#" class="" onclick="addTab('Analysis 1','<%=basePath%>admin/analysis_salesByDay')">Analysis one</a></li>
	            <li><a href="#" class="" onclick="addTab('Analysis 2','<%=basePath%>admin/analysis_amountByCategory')">Analysis two</a></li>
          	</ul>
		</div>
	...
	<script src="/bookstore/static/js/jquery.easyui.min.js"></script>
	<script src="/bookstore/static/js/iframeResizer.min.js"></script>
